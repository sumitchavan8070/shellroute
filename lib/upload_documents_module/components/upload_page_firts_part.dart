...
class UploadPageFirstPart extends StatefulWidget {
  const UploadPageFirstPart({
    super.key,
    required this.index,
  ...
  @override
  State<UploadPageFirstPart> createState() => _UploadPageFirstPartState();
}

GetXMainController controller = Get.find<GetXMainController>();

PlatformFile? localFile;
class _UploadPageFirstPartState extends State<UploadPageFirstPart> {
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                () async {
                                  ...
                                  debugPrint("this is from the repallce fiel ${controller.localFile[0]}");
